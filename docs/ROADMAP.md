...
1. Deploy reviewed monitoring implementation, enable sanitized L0/L1/L2 by
   gate, and complete the 48-hour canary soak.
2. Run an explicitly approved voluntary pilot of 3–5 users, preserving direct
   VLESS rollback.
3. Enable opt-in bot subscription delivery only after pilot evidence.
4. Separately design/test billing and `expiryTime` synchronization; preserve
