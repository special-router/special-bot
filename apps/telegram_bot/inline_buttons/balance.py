...
async def get_reply_markup_balance(user: TelegramUser) -> InlineKeyboardMarkup:
    buttons: list[list[InlineKeyboardButton]] = [
        ...
        [
            InlineKeyboardButton(
                text='Пополнить на два месяца',
                callback_data='top_up_balance_two_month',
            ),
        ],
        [
            InlineKeyboardButton(
                text='Пополнить на три месяца',
                callback_data='top_up_balance_three_month',
            ),
        ],
        [
            InlineKeyboardButton(text='Пополнить на полгода', callback_data='top_up_balance_six_month'),
        ],
        [
            InlineKeyboardButton(text='Пополнить на год', callback_data='top_up_balance_year'),
        ],
    ]
